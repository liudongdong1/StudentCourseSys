...
import com.ldd.coursemanage.R;             // 通过R直接获取资源course.setImageId(R.drawable.sport);
    ...
    private CourseSec parseCourseSec(Cursor cursor) {
        ...
        switch (id){
            ...
            case 10005:
                ...
                break;
            case 10006:
                course.setImageId(R.drawable.history);
                break;
            case 10007:
                course.setImageId(R.drawable.geography);
                break;
            case 10008:
                course.setImageId(R.drawable.chemistry);
                break;
            default:
